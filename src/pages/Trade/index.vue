  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="index"
        @click="changeIsDefault(address, addresses)"
      >
      ...
      <div class="address clearFix">
        ...
        <span
          ...
          :class="{ selected: paymentWay == 'OUTLINE' }"
          @click="paymentWay = 'OUTLINE'"
          >货到付款</span
        >
      </div>
      <div class="line"></div>
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="order.imgUrl" alt="" style="width: 70px; height: 70px" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
...
export default {
  ...
  methods: {
    changeIsDefault(address, addresses) {
      // 地址选择：排他思想
    ...
    async submitOrder() {
      ...
      let consignee = this.userDefaultAddress.consignee;
      let consigneeTel = this.userDefaultAddress.phoneNum;
      let deliveryAddress = this.userDefaultAddress.fullAddress;
      let paymentWay = this.paymentWay;
      let orderComment = this.msg;
      let orderDetailList = this.orderDetail;
      // 发请求提交订单
      let result = await this.$API.reqSubmitOrder(traderNo, {
        consignee,
        consigneeTel,
        deliveryAddress,
        paymentWay,
