            ...
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd
                  ...
                  @click="
                    changeActive(attrValue, saleAttr.spuSaleAttrValueList)
                  "
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                  v-model="skuNumber"
                  @change="inputSkuNumber"
                />
                <a
                  href="javascript:"
                  class="plus"
                  @click="skuNumber >= 1 ? skuNumber++ : 1"
                  >+</a
                >
                <a
                  href="javascript:"
              ...
              <div class="add">
                <a
                  href="javascript:"
                  @click="addShopCartSuccess(skuId, skuNumber)"
                  >加入购物车</a
                >
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    inputSkuNumber(event) {
      let value = this.skuNumber * 1;
    ...
    async addShopCartSuccess(skuId, skuNumber) {
      try {
        // 发请求，将加购物车数据请求存入数据库
        ...
        // 路由跳转
        this.$router.push(
          `/addcartsuccess?skuId=${skuId}&skuNumber=${skuNumber}`
        );
